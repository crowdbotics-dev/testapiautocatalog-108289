...
## Project Structure
    ...
    ├── testapiautocatalog_108289  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_108289`
...
2. Clone this repo and `cd testapiautocatalog_108289`
